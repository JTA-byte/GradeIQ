...
function toCacheRow(signal: BuySignal, computedAt: string) {
  return {
    ...
    tier1_price: signal.tier1Price,
    tier1_roi_percent: signal.tier1RoiPct,
    tier1_max_buy_price: signal.tier1MaxBuyPrice,
    tier2_price: signal.tier2Price,
    tier2_roi_percent: signal.tier2RoiPct,
    tier2_max_buy_price: signal.tier2MaxBuyPrice,
